<template>
  <div>
    ...
    <div style="margin: 10px 0">
      <el-input suffix-icon="el-icon-search" style="width:200px" placeholder="请输入名称" v-model="deptname"></el-input>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="headerBg" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="deptid" label="学院号" width="140"></el-table-column>
      <el-table-column prop="deptname" label="学院名" width="120"></el-table-column>
      <el-table-column prop="address" label="地址"></el-table-column>
      <el-table-column prop="phonecode" label="电话号码"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    del(deptid){
      this.request.delete("/department/"+deptid).then(res=>{
        if(res){
    ...
    delBatch(){
      let deptids=this.multipleSelection.map(v => v.deptid)  //[{},{},{}] => [1,2,3] 把一个对象数组转换成纯数组
      this.request.post("/department/del/batch",deptids).then(res=>{
        if(res){
